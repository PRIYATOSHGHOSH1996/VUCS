...
@Entity(tableName = "dt_class_notice_file")
public class ClassNoticeFileModel {
    ...
    @Ignore
    public ClassNoticeFileModel() {

    }

    public ClassNoticeFileModel(int noticeId, String noticeFileURI) {
