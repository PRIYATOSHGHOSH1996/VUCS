...
public class LoginActivity extends AppCompatActivity {
    ...
    private void test(){
       BlogDAO blogDAO = new BlogDAOImplementation(this);
      NoticeDAO noticeDAO = new NoticeDAOImplementation(this);
       EventDAO eventDAO = new EventDAOImplementation(this);
      ImageGalleryDAO imageGalleryDAO =new ImageGalleryDAOImplementation(this);
      PhirePawaProfileDAO phirePawaProfileDAO = new PhirePawaDAOImplementation(this);
        phirePawaProfileDAO.insertUser(new PhirePawaProfileModel(1,"Priyatosh Ghosh",2019,"Frametrics Consulting Pvt.","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/l4.jpg?alt=media&token=724fd54b-68ce-4551-af9b-7c4364de32b6"));
        phirePawaProfileDAO.insertUser(new PhirePawaProfileModel(2,"Saikat Ghorai",2019,"Frametrics Consulting Pvt.","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/video-bg.jpg?alt=media&token=d1f837f2-460f-401f-aa03-cb68f4c3d33d"));
        phirePawaProfileDAO.insertUser(new PhirePawaProfileModel(3,"Preetam Sarkar",2019,"Avalgate.","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/top-post1.jpg?alt=media&token=d5bba49a-8e03-47db-a72f-ca941db12720"));
        phirePawaProfileDAO.insertUser(new PhirePawaProfileModel(4,"Rohit Sing",2019,"The AdView.","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/f1.jpg?alt=media&token=a859166f-679e-4181-b4cc-f266a4bd4be9"));
        phirePawaProfileDAO.insertUser(new PhirePawaProfileModel(5,"Sovon Jana",2019,"The AdView.","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/l2.jpg?alt=media&token=02d5c867-c5cc-4bad-93e8-8b023cc478fd"));
        ...
        imageGalleryDAO.insertImage(new ImageGalleryModel(2,"folder1","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/video-bg.jpg?alt=media&token=d1f837f2-460f-401f-aa03-cb68f4c3d33d"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(3,"folder1","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/video-bg.jpg?alt=media&token=d1f837f2-460f-401f-aa03-cb68f4c3d33d"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(4,"folder1","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/video-bg.jpg?alt=media&token=d1f837f2-460f-401f-aa03-cb68f4c3d33d"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(5,"folder1","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/video-bg.jpg?alt=media&token=d1f837f2-460f-401f-aa03-cb68f4c3d33d"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(6,"folder1","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/video-bg.jpg?alt=media&token=d1f837f2-460f-401f-aa03-cb68f4c3d33d"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(7,"folder1","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/video-bg.jpg?alt=media&token=d1f837f2-460f-401f-aa03-cb68f4c3d33d"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(8,"folder2","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/top-post1.jpg?alt=media&token=d5bba49a-8e03-47db-a72f-ca941db12720"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(9,"folder2","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/top-post1.jpg?alt=media&token=d5bba49a-8e03-47db-a72f-ca941db12720"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(10,"folder2","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/top-post1.jpg?alt=media&token=d5bba49a-8e03-47db-a72f-ca941db12720"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(11,"folder2","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/top-post1.jpg?alt=media&token=d5bba49a-8e03-47db-a72f-ca941db12720"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(12,"folder2","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/top-post1.jpg?alt=media&token=d5bba49a-8e03-47db-a72f-ca941db12720"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(13,"folder2","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/top-post1.jpg?alt=media&token=d5bba49a-8e03-47db-a72f-ca941db12720"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(14,"folder2","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/top-post1.jpg?alt=media&token=d5bba49a-8e03-47db-a72f-ca941db12720"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(15,"folder2","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/top-post1.jpg?alt=media&token=d5bba49a-8e03-47db-a72f-ca941db12720"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(16,"folder2","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/top-post1.jpg?alt=media&token=d5bba49a-8e03-47db-a72f-ca941db12720"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(17,"folder2","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/top-post1.jpg?alt=media&token=d5bba49a-8e03-47db-a72f-ca941db12720"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(18,"folder2","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/top-post1.jpg?alt=media&token=d5bba49a-8e03-47db-a72f-ca941db12720"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(19,"folder2","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/top-post1.jpg?alt=media&token=d5bba49a-8e03-47db-a72f-ca941db12720"));
        imageGalleryDAO.insertImage(new ImageGalleryModel(20,"folder2","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/top-post1.jpg?alt=media&token=d5bba49a-8e03-47db-a72f-ca941db12720"));
        ...
        blogDAO.insertBlog(new BlogModel(8,"Sunrisers Hyderabad head coach Tom Moody said that were hopeful of captain Kane Williamson being available (who missed the first game due to injury) for selection against Rajasthan Royals.\n" +
                ...
                "On the possibility of Rahul Tripathi batting up the order, Unadkat said it depended on what the coach or the captain prefer. “I think they see Rahul as a batter who can play in any position and not necessarily at the top,” he said.\n" +
                "\n" +
                "Unadkat said that they have left behind the R. Ashwin episode (running out Jos Buttler) and just wanted to move on. “It didn’t have any impact on the team. It is important to focus on the games ahead,” he said.","Sovon Jana",System.currentTimeMillis(),"Royal Challengers Bangalore opted to field after winning the toss against Mumbai Indians in the second IPL encounter between the two teams.\n" +
                "\n" +
        ...
        blogDAO.insertBlog(new BlogModel(7,"Royal Challengers Bangalore opted to field after winning the toss against Mumbai Indians in the second IPL encounter between the two teams.\n" +
                ...
                "Royal Challengers Bangalore:  Virat Kohli (capt), Parthjv Patel (wk), Moeen Ali, AB de Villiers, Shimron Hetmyer, Shivam Dube, Colin de Grandhomme, Navdeep Saini, Yuzvendra Chahal, Umesh Yadav, Mohammed Siraj\n" +
                "\n" +
                "Mumbai Indians: Rohit Sharma (c), Quinton de Kock (wk), Suryakumar Yadav, Yuvraj Singh, Kieron Pollard, Hardik Pandya, Krunal Pandya, Mayank Markande, Mitchell McClenaghan, Lasith Malinga, Jasprit Bumrah","Preetam Sarkar",System.currentTimeMillis(),"Martin Guptill is not among the four first-choice overseas players for Sunrisers Hyderabad but the senior New Zealand batsman wants to utilise his time facing Rashid Khan at the nets to prepare for the World Cup game against Afghanistan on June 8.\n" +
                "\n" +
