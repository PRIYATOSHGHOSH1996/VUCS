...
public abstract class AppDatabase extends RoomDatabase {
    ...
    private static class PopulateDbAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(final Void... params) {
            ...
            teacherDAO.insertTeacher(new TeacherModel("3","teacher 3","https://firebasestorage.googleapis.com/v0/b/chattingapp-8dde4.appspot.com/o/l4.jpg?alt=media&token=724fd54b-68ce-4551-af9b-7c4364de32b6", "jhfesduy", "gdfgaseiodyfcgusaedlfcbiularsdogfisakdgfuysgzdcisagduifa",3));
